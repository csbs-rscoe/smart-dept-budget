...
export default function ExpensesPage() {
    ...
    // Sync selectedExpense with refreshed expenses list
    useEffect(() => {
    ...
    const getBudgetRemaining = () => {
        ...
        // Use pre-calculated remaining from API, then subtract the new expense amount
        return budget.remaining - newExpenseAmount;
    };
                ...
                <div className="flex gap-4">
                    ...
                    <Button variant="outline" onClick={() => setShowFilters(!showFilters)}>
                        <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707L10 10v6a1 1 0 00.553.894l4 2A1 1 0 0016 18v-8l4.293-4.293a1 1 0 01.293-.707V5a1 1 0 011-1H4z" />
                        </svg>
                        Filters
                    </Button>
                </div>
