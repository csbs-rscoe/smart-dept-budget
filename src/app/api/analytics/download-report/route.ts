    ...
    switch (type) {
      ...
      case 'budget':
        ...
        columns = [
          ...
          { key: 'proposed', header: 'Proposed', width: 90, align: 'right' as const },
          { key: 'allotted', header: 'Allotted', width: 90, align: 'right' as const },
          { key: 'variance', header: 'Variance', width: 90, align: 'right' as const },
      ...
      case 'vendor':
        ...
        columns = [
          ...
          { key: 'approved', header: 'Approved', width: 90, align: 'right' as const },
          { key: 'pending', header: 'Pending', width: 90, align: 'right' as const },
          { key: 'total', header: 'Total', width: 90, align: 'right' as const },
        ];
