      ...
      {user && (
        <div className="border-t border-slate-200 p-3">
          ...
          {!isCollapsed && (
            <button
              onClick={logout}
              className="mt-3 w-full text-left px-3 py-2 text-sm text-red-600 hover:bg-red-50 rounded-lg transition-colors flex items-center gap-2"
            >
          ...
          {isCollapsed && (
            <button
              onClick={logout}
              className="mt-3 w-full flex justify-center p-2 text-red-600 hover: bg-red-50 rounded-lg transition-colors"
              title="Sign Out"
            >
